...
class RequestPaymentView extends GetView<RequestPaymentController> {
  RequestPaymentView({Key? key}) : super(key: key);
  RequestPaymentController controller = Get.put(RequestPaymentController());

  @override
  Widget build(BuildContext context) {
    return GetBuilder<RequestPaymentController>(builder: (value) {
      return Scaffold(
